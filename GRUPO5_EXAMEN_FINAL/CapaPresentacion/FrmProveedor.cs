    ...
    public partial class FrmProveedor : Form
    {
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            men = or_proovedorBL.agregarProovedor(new R_Proovedor(cboTipoProve.SelectedItem.ToString(), cboTipoDoc.SelectedItem.ToString(),
                txtnumerodoc.Text, txtapepat.Text, txtapemat.Text, txtnombre.Text, txtruc.Text, txtrazon.Text, txtdomi.Text, txtdepar.Text,
                txtprovi.Text, txtdis.Text, txttele.Text, txtcontacto.Text, txtcorreo.Text, txtbanco.Text,Int32.Parse(txtnumcuenta.Text), Int32.Parse(txtnuminter.Text),
                txtestado.Text));
        ...
        {
            string men;
            men= or_proovedorBL.actualizarProovedor(new R_Proovedor(cboTipoProve.SelectedItem.ToString(), cboTipoDoc.SelectedItem.ToString(),
                txtnumerodoc.Text, txtapepat.Text, txtapemat.Text, txtnombre.Text, txtruc.Text, txtrazon.Text, txtdomi.Text, txtdepar.Text,
                txtprovi.Text, txtdis.Text, txttele.Text, txtcontacto.Text, txtcorreo.Text, txtbanco.Text, Int32.Parse(txtnumcuenta.Text), Int32.Parse(txtnuminter.Text),
                txtestado.Text));
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                txtdepar.Text = or_Proovedor.departamento;
                txtprovi.Text = or_Proovedor.provincia;
                txtdis.Text = or_Proovedor.distrito;
                ...
                txtestado.Text = or_Proovedor.estado;
            }
